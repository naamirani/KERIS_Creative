...
public class Timepoint {
    ...
    HashMap<Integer,List<String>> neuronStatus;
    int currLabelIndex;
    String timepointNum="";
    int tpIndex=0;
    ...
    public Timepoint(String timepointNum) {
        ...
        neuronStatus = new HashMap<Integer,List<String>>();
        currLabelIndex = 1;
    ...
    public void add(Neuron neuron,  HashMap<Integer,List<String>> statuses, Integer index, String result, Boolean isCustom) {
        ...
        neuronStatus.put(index,neuron.status);
    ...
    public HashMap<Integer,List<String>> getNeuronStatus(){
        return this.neuronStatus;
    }
